...
public class appWeka {    
    public static void main(String[] args) throws IOException, CsvValidationException {
        ...
        try {
            properties.load(new FileInputStream(new File("myapp/src/main/java/config.properties")));
            InstanceQuery query = new InstanceQuery();
            query.setDatabaseURL(properties.getProperty("jdbc"));
            query.setUsername(properties.getProperty("USUARIO"));
            query.setPassword(properties.getProperty("CLAVE"));
